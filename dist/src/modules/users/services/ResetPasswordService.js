...
var ResetPasswordEmailService = /** @class */ (function () {
    function ResetPasswordEmailService(usersRepository, userTokensRepository, hashProvider) {
        this.usersRepository = usersRepository;
        this.userTokensRepository = userTokensRepository;
        this.hashProvider = hashProvider;
    }
    ResetPasswordEmailService.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        // console.log(differenceInHours(Date.now(), userToken.created_at));
                        if (date_fns_1.differenceInHours(Date.now(), userToken.created_at) > 2) {
    ...
    ResetPasswordEmailService = __decorate([
    ...
    return ResetPasswordEmailService;
}());
exports.default = ResetPasswordEmailService;
