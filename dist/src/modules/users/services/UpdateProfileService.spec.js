...
describe('UpdateProfile', function () {
    beforeEach(function () {
        ...
        updateProfileService = new UpdateProfileService_1.default(fakeUserRespository, fakeHashProvider);
    });
    it('should be able to update the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, updatedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRespository.create({
                        name: 'John Doe',
    ...
    it('should not be able to update password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRespository.create({
    ...
    it('should not be able update the the profile from non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
