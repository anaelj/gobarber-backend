...
var fakeAppointmentRespository;
var createAppointment;
var fakeNotificationsRespository;
var fakeCacheProvider;
describe('CreateAppointment', function () {
    beforeEach(function () {
        fakeAppointmentRespository = new FakeAppointmentsRepository_1.default();
        fakeNotificationsRespository = new FakeNotificationsRepository_1.default();
        fakeCacheProvider = new FakeCacheProvider_1.default();
        createAppointment = new CreateAppointmentService_1.default(fakeAppointmentRespository, fakeNotificationsRespository, fakeCacheProvider);
    });
    ...
    it('should not be able to create an appointment on the past date', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
