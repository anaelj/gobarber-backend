...
describe('ListProviderAppointments', function () {
    beforeEach(function () {
        ...
        listProviderAppointmentsService = new ListProviderAppointmentsService_1.default(fakeAppointmentsRepository, fakeCacheProvider);
    });
    it('should be able to list the appointments on a especific day by provider', function () { return __awaiter(void 0, void 0, void 0, function () {
